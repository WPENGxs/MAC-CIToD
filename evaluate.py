# encoding=utf8
# The code is derived from https://github.com/yizhen20133868/CI-ToD/blob/main/utils/evaluate.py
...
class EvaluateTool(object):
    ...
    def evaluate(pred, dataset, args=''):
        ...
        gold_qi = [gold_i[0] for gold_i in dataset]
        gold_hi = [gold_i[1] for gold_i in dataset]
        gold_kbi = [gold_i[2] for gold_i in dataset]
        summary = {}
        ...
        summary["overall_acc"] = sum([1 for pred_i, gold_i in zip(pred, dataset) if pred_i == gold_i]) / len(dataset)
